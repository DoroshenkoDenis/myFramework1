package com.framework.dd.data.vacancies;

public class Vacancy {
    public static final String vacancyName = "Инженер-стажер по автоматизированному тестированию";
    public static final String firstName = "Denis";
    public static final String lastName = "Doroshenko";
